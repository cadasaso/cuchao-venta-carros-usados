"""
Django settings for cuchao project.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-yx%8++#d7mrex*5jp7ziok-u)^_s3jx0r4d+@e-gzmi#l#d*2w'
)
...
AUTH_USER_MODEL = 'carros.Usuario'
...
WSGI_APPLICATION = 'cuchao.wsgi.application'
